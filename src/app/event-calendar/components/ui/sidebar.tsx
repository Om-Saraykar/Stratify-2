  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "relative w-(--sidebar-width) bg-transparent transition-[width] duration- ease-[cubic-bezier(0.65,0,0.35,1)]",
          "group-data-[collapsible=offcanvas]:w-0",
          // Removed group-data-[side=right]:rotate-180 if it's not serving a purpose for gap positioning
          side === "right" ? "ml-auto" : "", // Add this line to push the gap to the right
      ...
      <div
        ...
        className={cn(
          "relative inset-y-0 z-10 hidden h-svh w-(--sidebar-width) transition-[left,right,width] duration-300 ease-[cubic-bezier(0.65,0,0.35,1)] lg:flex",
          side === "left"
